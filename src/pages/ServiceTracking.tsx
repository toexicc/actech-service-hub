          ...
          return (
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {/* Interim report also shows when the diagnosis block is hidden for
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <Card className="border-border/60 bg-[hsl(var(--surface-glass))] backdrop-blur-xl shadow-[var(--shadow-elegant)] rounded-2xl">
                  ...
                  {/* Device Photo Gallery - Diagnosis, Interim & Report (gated by status; each panel hides itself when empty) */}
