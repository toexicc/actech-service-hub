...
import fs from "fs";
import { drawQuotation } from "./src/lib/quotationPdfGenerator";
...
Extended findings paragraph for stress testing purposes with additional detail about the device condition, water exposure, prior repairs, and observed component failures across the logic board and peripherals.
...
Service Breakdown:
- Charging port replacement - Php 8,000
- Logic board component CD32 replacement - Php 9,500
- Cleaning and corrosion treatment - Php 2,500
- Battery replacement - Php 3,200
- Display assembly replacement - Php 12,000
- Full diagnostics and labor - Php 1,500
SUMMARY:
...
fs.writeFileSync("/mnt/documents/service-quotation-premium-preview_stress.pdf", Buffer.from(doc.output("arraybuffer")));
